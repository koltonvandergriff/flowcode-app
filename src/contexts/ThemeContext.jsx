...
export const ThemeContext = createContext({
  theme: DARK_COLORS,
  terminalTheme: PALETTE_TERMINALS.flowade,
  themeName: 'dark',
  paletteName: 'flowade',
  toggleTheme: () => {},
  setPalette: () => {},
...
export function ThemeProvider({ children }) {
  ...
  const [paletteName, setPaletteName] = useState('flowade');
  ...
  const terminalTheme = themeName === 'dark' ? (PALETTE_TERMINALS[paletteName] || PALETTE_TERMINALS.flowade) : LIGHT_TERMINAL_THEME;
